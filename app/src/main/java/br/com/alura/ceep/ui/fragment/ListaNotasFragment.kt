...
class ListaNotasFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        var listaNotasBinding = ListaNotasBinding.inflate(inflater, container, false)

        listaNotasBinding.clickListenerAdd = View.OnClickListener {
            vaiParaFormulario()
        }

        return listaNotasBinding.root
    }
